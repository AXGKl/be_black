...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -B /tmp/black/compiler_compat '
              '-L/tmp/black/lib '
              '-Wl,-rpath=/tmp/black/lib -Wl,--no-as-needed '
              '-Wl,--sysroot=/',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /tmp/black/compiler_compat -Wl,--sysroot=/',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '-I/tmp/black/include',
 'CONFIGURE_LDFLAGS': '-L/tmp/black/lib '
                      '-Wl,-rpath=/tmp/black/lib -Wl,--no-as-needed '
                      '-Wl,--sysroot=/',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                ...
                "-ltcl8.6 -ltk8.6' "
                "'CPPFLAGS=-I/tmp/black/include' "
                "'LDFLAGS=-L/tmp/black/lib "
                "-Wl,-rpath=/tmp/black/lib -Wl,--no-as-needed -Wl,--sysroot=/' "
                "'PKG_CONFIG_PATH=/tmp/black/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/tmp/black/include',
 'CONFINCLUDEPY': '/tmp/black/include/python3.7m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/tmp/black/../work/Python-3.7.3/coverage.info',
 'COVERAGE_REPORT': '/tmp/black/../work/Python-3.7.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/tmp/black/include',
 'CXX': 'g++ -pthread -B /tmp/black/compiler_compat -Wl,--sysroot=/',
 'DESTDIRS': '/tmp/black '
             '/tmp/black/lib '
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared -B /tmp/black/compiler_compat '
                '-L/tmp/black/lib '
                '-Wl,-rpath=/tmp/black/lib -Wl,--no-as-needed '
                '-Wl,--sysroot=/',
 'LDFLAGS': '-L/tmp/black/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -B /tmp/black/compiler_compat '
             '-L/tmp/black/lib '
             '-Wl,-rpath=/tmp/black/lib -Wl,--no-as-needed '
             '-Wl,--sysroot=/',
 'LDVERSION': '3.7m',
 ...
 'LIBPL': '/tmp/black/lib/python3.7/config-3.7m-x86_64-linux-gnu',
 'LIBRARY': 'libpython3.7m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -lutil -lrt',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'gcc -pthread -B /tmp/black/compiler_compat -Wl,--sysroot/',
 ...
 'MAINCC': 'gcc -pthread -B /tmp/black/compiler_compat -Wl,--sysroot=/',
 'MAJOR_IN_MKDEV': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/black/../work/Python-3.7.3',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/black/../work/Python-3.7.3 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/black/../work/Python-3.7.3 '
 ...
 'abs_builddir': '/tmp/black/../work/Python-3.7.3',
 'abs_srcdir': '/tmp/black/../work/Python-3.7.3',
