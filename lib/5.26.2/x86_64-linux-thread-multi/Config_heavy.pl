...
config_arg2='-Dprefix=/tmp/black'
config_arg3='-Dusethreads'
config_arg4='-Duserelocatableinc'
config_arg5='-Dcccdlflags=-fPIC'
config_arg6='-Dldflags=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib'
...
config_arg9='-Dlddlflags=-shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib'
config_argc='10'
config_args='-de -Dprefix=/tmp/black -Dusethreads -Duserelocatableinc -Dcccdlflags=-fPIC -Dldflags=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib -Ddefault_inc_excludes_dot=n -Dcc=/tmp/build/80754af9/perl_1527832170752/_build_env/bin/x86_64-conda_cos6-linux-gnu-gcc -Dlddlflags=-shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib -Dsysroot=/tmp/build/80754af9/perl_1527832170752/_build_env/x86_64-conda_cos6-linux-gnu/sysroot'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
lddlflags='-shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib --sysroot /tmp/build/80754af9/perl_1527832170752/_build_env/x86_64-conda_cos6-linux-gnu/sysroot -fstack-protector-strong'
ldflags='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib -fstack-protector-strong'
...
ldflags_nolargefiles='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/tmp/black/lib -L/tmp/black/lib -fstack-protector-strong'
